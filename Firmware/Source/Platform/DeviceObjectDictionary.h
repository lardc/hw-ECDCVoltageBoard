...
#define REG_DAC_I1_OFFSET				6	// Оффсет пересчёта тока в ЦАП диапазона 1 (в мВ выхода ЦAП)
...
#define REG_DAC_I2_OFFSET				9	// Оффсет пересчёта тока в ЦАП диапазона 2 (в мВ выхода ЦAП)
...
#define REG_DAC_I3_OFFSET				12	// Оффсет пересчёта тока в ЦАП диапазона 3 (в мВ выхода ЦAП)
...
#define REG_DAC_I4_OFFSET				15	// Оффсет пересчёта тока в ЦАП диапазона 4 (в мВ выхода ЦAП)

#define REG_I_RANGE1_RES				16	// Сопротивление шунтовых резисторов диапазона 1 (в Омах)
#define REG_I_RANGE2_RES				17	// Сопротивление шунтовых резисторов диапазона 2 (в Омах)
#define REG_I_RANGE3_RES				18	// Сопротивление шунтовых резисторов диапазона 3 (в Омах)
#define REG_I_RANGE4_RES				19	// Сопротивление шунтовых резисторов диапазона 4 (в Омах)
