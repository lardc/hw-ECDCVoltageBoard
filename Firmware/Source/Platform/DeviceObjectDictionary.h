...
#define REG_I_CUTTOF_CTRL_DEL			36	// Задержка включения слежения за током отсечки после выхода на полку напряжения (мс * 10)
#define REG_I_CUTOFF_CTRL_DEL_EN		37	// Включение задержки слежения за током отсечки
...
#define REG_DIAG_DISABLE_VI_LIMIT		189	// Отключение срабатывания защиты по достижению лимита тока и напряжения
