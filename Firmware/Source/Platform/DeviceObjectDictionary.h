...
#define REG_ADC_I1_CONV_B				45	// Оффсет оцифровки тока диапазона 1
...
#define REG_ADC_I2_CONV_B				51	// Оффсет оцифровки тока диапазона 2
...
#define REG_ADC_I3_CONV_B				57	// Оффсет оцифровки тока диапазона 3
...
#define REG_ADC_I4_CONV_B				63	// Оффсет оцифровки тока диапазона 4
...
#define REG_ADC_V1_CONV_B				69	// Оффсет оцифровки напряжения диапазона 1
...
#define REG_ADC_V2_CONV_B				75	// Оффсет оцифровки напряжения диапазона 2
...
#define REG_ADC_V3_CONV_B				81	// Оффсет оцифровки напряжения диапазона 3
...
#define REG_ADC_V4_CONV_B				87	// Оффсет оцифровки напряжения диапазона 4
